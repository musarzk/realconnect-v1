...
import { Filter, ChevronDown, Grid3x3, List, X } from "lucide-react";
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 pt-12 flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Filters Sidebar */}
          <div className={`lg:col-span-1 transition-all duration-300 ease-in-out ${filtersOpen ? "max-h-[2000px] opacity-100 mb-6" : "max-h-0 opacity-0 overflow-hidden mb-0"} lg:max-h-full lg:opacity-100 lg:overflow-visible lg:mb-0`}>
